...
'<script src="sterm.js"></script>'+
'<script src="ganzhi.js"></script>'+
'<script src="lunar.js"></script>'+
'<script src="string.js"></script>'+
'<script src="ftvl.js"></script>'+
...
function CCC(year,month,date,time,zone,calType){
  ...
  if(calType==null&&zone==null&&time==null){
      time="0:0:0:0";  //默认为零时
      zone=8;  //默认为北京时间
  ...
  //四参数
  else if(calType==null&&zone==null){
