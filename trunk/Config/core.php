 ...
 *
 */
Configure::write('Routing.prefixes', array('mytest.51yilife.com/admin/controller'));
 ...
 */
	Configure::write('Security.salt', 'dianbo.yiflie.member.378249107438190');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '74389473927834927839');
